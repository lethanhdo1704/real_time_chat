...
/**
 * VideoAttachment Component - BEAUTIFUL GRADIENT STYLE
 * 
 * Features:
...
export default function VideoAttachment({ attachment, isMe }) {
  ...
  return (
    <div className="rounded-xl overflow-hidden bg-linear-to-br from-purple-500 to-purple-700 max-w-sm shadow-lg hover:shadow-2xl transition-all duration-300">
      {!showPlayer ? (
        ...
        >
          ...
          {!posterError ? (
            ...
            <div className="w-full h-full bg-linear-to-br from-purple-400 via-purple-500 to-purple-600 flex items-center justify-center">
          ...
          <div className="absolute inset-0 bg-linear-to-t from-black/60 via-black/20 to-transparent group-hover:from-black/40 transition-all duration-300">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-3">
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm text-white font-medium truncate flex-1">{name}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative bg-black">
          ...
          {/* File info bar */}
          <div className="bg-linear-to-r from-purple-600 to-purple-700 p-3">
