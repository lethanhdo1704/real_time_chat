 ...
 * 
 * Displays chat header with:
 * - Receiver avatar & name
 * - Online status
 * - Typing indicator with animation
 * - Action buttons (future: call, video, info)
 */
export default function ChatHeader({ 
  ...
  isTyping = false,
  typingUserName,
  isOnline = true, // Future: real online status
  onCallClick, // Future: voice call
  onVideoClick, // Future: video call
  onInfoClick, // Future: conversation info
}) {
