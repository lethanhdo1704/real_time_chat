            ...
            >
              <div className="flex items-center justify-center gap-2">
                <div className="relative">
                  ...
                  {requestCount > 0 && (
                    <span className="absolute -top-1.5 -right-1.5 flex items-center justify-center min-w-[18px] h-[18px] px-1 text-[10px] font-bold text-white bg-red-500 rounded-full border-2 border-white shadow-sm">
