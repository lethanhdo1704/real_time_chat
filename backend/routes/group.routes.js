...
router.post(
  ...
  groupController.markAllNotificationsAsRead
);

// Mark single notification as read
router.post(
  "/notifications/:notificationId/read",
  groupController.markNotificationAsRead
);
...
// 🔥 NEW: Invite link management routes
router.post(
...
router.get(
  "/:conversationId/invite-links",
  checkMembership,
  groupController.getInviteLinks
);

router.delete(
  "/:conversationId/invite-links/:linkId",
  checkAdminRole,
  groupController.deactivateInviteLink
);
...
router.post(
  "/:conversationId/transfer-and-leave",
  checkOwnerRole,
  groupController.transferOwnershipAndLeave
);
